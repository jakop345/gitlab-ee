...
### Clone the Source
    ...
    sudo -u git -H git clone https://gitlab.com/subscribers/gitlab-ee.git -b 7-7-stable-ee gitlab


**Note:** You can change `7-7-stable-ee` to `master` if you want the *bleeding edge* version, but never install master on a production server!
