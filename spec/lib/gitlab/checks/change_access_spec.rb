...
describe Gitlab::Checks::ChangeAccess, lib: true do
  describe '#exec' do
    ...
    let(:changes) { 'be93687618e4b132087f430a4d8fc3a609c9b77c 54fcc214b94e78d7a41a9a8fe6d87a5e59500e51 refs/heads/master' }
    ...
    context 'tags check' do
      let(:changes) { 'be93687618e4b132087f430a4d8fc3a609c9b77c 54fcc214b94e78d7a41a9a8fe6d87a5e59500e51 refs/tags/v1.0.0' }
    ...
    context 'protected branches check' do
      ...
      context 'branch deletion' do
        let(:changes) { 'be93687618e4b132087f430a4d8fc3a609c9b77c 0000000000000000000000000000000000000000 refs/heads/master' }
    ...
    context 'push rules checks' do
      ...
      context 'tag deletion' do
        let(:changes) { 'be93687618e4b132087f430a4d8fc3a609c9b77c 0000000000000000000000000000000000000000 refs/tags/v1.0.0' }
